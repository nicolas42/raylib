...
@set OUT_DIR=Debug
@set OUT_EXE=zomg
@set INCLUDES=/IC:\Users\Nick\raylib\raylib-4.5.0_win64_msvc16\include
@set SOURCES=main.c
@set LIBS=/LIBPATH:C:\Users\Nick\raylib\raylib-4.5.0_win64_msvc16\lib opengl32.lib gdi32.lib shell32.lib raylib.lib winmm.lib kernel32.lib user32.lib
